...
exitip = sys.argv[9]
exitport = sys.argv[10]
serverip = sys.argv[11]
serverport = sys.argv[12]
key1 = int (sys.argv[13])
key2 = int (sys.argv[14])
key3 = int (sys.argv[15])
key4 = int (sys.argv[16])
key5 = int (sys.argv[17])
